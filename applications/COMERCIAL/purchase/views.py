...
# ==================== REQUERIMIENTOS ====================
class RequirementListView(AdminClientsPermisoMixin,ListView):
  template_name = "COMERCIAL/requirement/requirement-lista.html"
...
class RequirementCreateView(AdminClientsPermisoMixin, CreateView):
    model = requirements
    form_class = RequirementsForm
    template_name = 'COMERCIAL/requirement/requirement-crear.html'
...
class RequirementDetailView(AdminClientsPermisoMixin, ListView):
    model = requirements
    template_name = 'COMERCIAL/requirement/requirement-detalle.html'
...
# ==================== CAJA CHICA ====================
class PettyCashListView(AdminClientsPermisoMixin,ListView):
...
class PettyCashCreateView(AdminClientsPermisoMixin, CreateView):
    model = PettyCash
...
class PettyCashDetailView(AdminClientsPermisoMixin, ListView):
    model = PettyCash
...
class PettyCashDeleteView(AdminClientsPermisoMixin,DeleteView):
