...
from applications.COMERCIAL.stakeholders.models import client, bankAccountsClient
...
class BankMovements(TimeStampedModel):
    ...
    originDestination = models.ForeignKey(client, on_delete=models.CASCADE, null=True, blank=True, related_name="Finantial_originDestination")
...
def search_tinAccounts(sender, instance, **kwargs):
    try:
        ...
        if codeNumber == "" or codeNumber == None:
            ...
            accountClient = bankAccountsClient.objects.filter(
