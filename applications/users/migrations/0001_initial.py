    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.CharField(blank=True, choices=[('0', 'Administrador'), ('1', 'Contabilidad'), ('2', 'Supervisor producción'), ('3', 'Supervisor compras'), ('4', 'Trabajador')], max_length=1, verbose_name='Tipo de usuario')),
